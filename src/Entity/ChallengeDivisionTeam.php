...
#[ORM\Table(name: 'challenge_division_team', uniqueConstraints: [new ORM\UniqueConstraint(name: 'challenge_division_team_team_id_uindex', columns: ['team_id']), new ORM\UniqueConstraint(name: 'challenge_division_team_challenge_division_id_uindex', columns: ['challenge_division_id'])])]
#[ORM\Entity(repositoryClass: \App\Repository\ChallengeDivisionTeamRepository::class)]
class ChallengeDivisionTeam implements JsonSerializable
{
    /**
     * @var int
     */
     ...
     */
    #[ORM\ManyToOne(targetEntity: ChallengeDivision::class)]
    ...
    public function jsonSerialize(): array
    {
        return [
            'id' => $this->getId(),
            'challengeDivision' => $this->getChallengeDivision(),
            'team' => $this->getTeam(),
